...
class _FornecedorPageState extends State<FornecedorPage> {
  ...
  Widget _statusCard(BuildContext context, bool online, ColorScheme colors) {
    final isHorario = controller.tipoFornecedor == TipoFornecedor.horario;
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              isHorario ? 'Funcionamento por horário' : 'Gestão da loja',
              style: Theme.of(context).textTheme.titleMedium,
            ),
            const SizedBox(height: 4),
            Text(
              'Recebimento de vendas pelo aplicativo',
              style: Theme.of(context).textTheme.bodyMedium,
            ),
            if (controller.fornecedorDisponibilidadeLoading) ...[
              const SizedBox(height: 8),
              const Text('Consultando disponibilidade comercial...'),
            ] else if (isHorario &&
                controller.fornecedorDisponivelComercialmente != null) ...[
              const SizedBox(height: 8),
              Text(commercialText),
