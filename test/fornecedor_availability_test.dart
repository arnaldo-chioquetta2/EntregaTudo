...
void main() {
  ...
  testWidgets('HORARIO mostra disponibilidade comercial separada do app',
    ...
    expect(find.text('Ficar Online'), findsNothing);
    expect(find.text('Ficar Offline'), findsNothing);
    controller.disposeSession();
  });
  ...
  testWidgets('loading nao exibe offline antes do tipo', (tester) async {
    final controller = HomeOperationalController();
    controller.fornecedorDisponibilidadeLoading = true;
    ...
    expect(find.text('Ficar Online'), findsNothing);
    expect(
        find.text('Consultando disponibilidade comercial...'), findsOneWidget);
    controller.disposeSession();
  });
  ...
  testWidgets('erro comercial nao bloqueia CTA operacional', (tester) async {
    ...
    expect(find.text('Não foi possível identificar o tipo do fornecedor.'),
        findsOneWidget);
